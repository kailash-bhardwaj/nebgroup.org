...
add_shortcode("homesliderShortcode","homepageslider");
function homepageslider(){
	...
	<div class="banner-slider">
		...
		while ( have_posts() ) : the_post();
			?>
			<div>
				<div class="banner-slide" style="background-image:url(<?php echo the_post_thumbnail_url(); ?>);">
					<div class="content-wrap text-center">
						<div class="caption">
							<h1 class="banner-title"><?php the_field('slider_title'); ?></h1>
							<p class="banner-description"><?php the_field('slider_description'); ?></p>
							<?php 
							...
							if( $link ): 
								...
								?>
								<a class="button d-btn" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a>
							<?php endif; ?>
						</div>
					</div>
				</div>
...
add_shortcode("reviewsShortcode","reviews");
function reviews(){
	$args= array(
	...
	ob_start();
	?>
	<div class="testimonialWrapper slickLayout1 mt-5">
		<?php
		// The Query
		query_posts( $args );
		while ( have_posts() ) : the_post();
			...
			<div>
				<div class="testimonials_item">
					<div class="testimonials_content">
						...
						<div class="client-info d-flex flex-wrap align-items-center justify-content-start">
							<div class="client-image">
								<img src="<?php echo the_post_thumbnail_url(); ?>">
							</div>	
							<div class="client-info-text">
								<p class="m-0"><strong><?php the_field('author_name'); ?></strong></p>
								<p class="m-0"><?php the_field('author_designation'); ?></p>
							</div>		
...
//Custome style and script enqueue
...
function add_theme_scripts() {
	...
	wp_enqueue_style( 'slick-theme-style', get_stylesheet_directory_uri() . '/assets/css/slick-theme.css');
	wp_enqueue_style( 'custom-style', get_stylesheet_directory_uri() . '/assets/css/custom-style.css');

	wp_enqueue_script( 'bootstrap-script', get_template_directory_uri() . '/assets/js/bootstrap.bundle.min.js', array ( 'jquery' ), 1.1, true);
	wp_enqueue_script( 'slick-script', get_template_directory_uri() . '/assets/js/slick.min.js', array ( 'jquery' ), 1.1, true);	
	wp_enqueue_script( 'custom-script', get_template_directory_uri() . '/assets/js/custom-script.js', array ( 'jquery' ), 1.1, true);	
}
add_action( 'wp_enqueue_scripts', 'add_theme_scripts' );


// add site title on the site logo
add_filter( 'get_custom_logo', function( $html, $blog_id ) {
    $html = str_replace( 'class="custom-logo"', 'class="custom-logo" title="'.get_bloginfo("name").'" alt="'.get_bloginfo("name").'"', $html );
    return $html;
}, 10, 2 );
